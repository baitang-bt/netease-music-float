...
const MESSAGES = {
  "zh-CN": {
    ...
    "settings.titleFontZh": "中文标题字体",
    "settings.titleFontEn": "英文标题字体",
    "settings.titleFontJa": "日文标题字体",
  ...
  en: {
    ...
    "settings.titleFontZh": "Chinese title font",
    "settings.titleFontEn": "English title font",
    "settings.titleFontJa": "Japanese title font",
  ...
  ja: {
    ...
    "settings.titleFontZh": "中国語タイトル字体",
    "settings.titleFontEn": "英語タイトル字体",
    "settings.titleFontJa": "日本語タイトル字体",
